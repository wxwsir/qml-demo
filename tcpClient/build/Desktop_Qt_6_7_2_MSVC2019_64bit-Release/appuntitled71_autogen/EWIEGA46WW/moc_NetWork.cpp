...
Q_CONSTINIT static const uint qt_meta_data_CLASSNetWorkENDCLASS[] = {
 ...
 // methods: parameters
    QMetaType::Void, QMetaType::QString, QMetaType::UShort,   14,   15,
    QMetaType::Void,
    QMetaType::QString,
    QMetaType::QString,
    QMetaType::QString,
...
void NetWork::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->do_connected(); break;
        case 4: _t->do_disconnected(); break;
        case 5: _t->do_socketReadyRead(); break;
        case 6: _t->actConnect((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<quint16>>(_a[2]))); break;
        case 7: _t->actDisConnect(); break;
        case 8: { QString _r = _t->getLoIP();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 9: { QString _r = _t->getConnectedInfo();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 10: { QString _r = _t->getSocketState();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 11: { QString _r = _t->getDisConnectedInfo();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        ...
        {
            using _t = void (NetWork::*)(const QString & , int );
            if (_t _q_method = &NetWork::getMsgChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void NetWork::getMsgChanged(const QString & _t1, int _t2)
{
