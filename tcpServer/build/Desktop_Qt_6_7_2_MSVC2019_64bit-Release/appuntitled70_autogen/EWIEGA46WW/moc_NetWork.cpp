...
Q_CONSTINIT static const uint qt_meta_data_CLASSNetWorkENDCLASS[] = {
 ...
 // methods: name, argc, parameters, tag, flags, initial metatype offsets
       9,    2,   63,    2, 0x02,    7 /* Public */,
      12,    0,   68,    2, 0x02,   10 /* Public */,
 ...
 // methods: parameters
    QMetaType::QStringList, QMetaType::QString, QMetaType::Int,   10,   11,
    QMetaType::QString,
...
void NetWork::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: { QList<QString> _r = _t->startListens((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2])));
            if (_a[0]) *reinterpret_cast< QList<QString>*>(_a[0]) = std::move(_r); }  break;
        case 6: { QString _r = _t->getLoIP();
